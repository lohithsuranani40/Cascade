...
import 'package:projectapp1/languages/englishpage.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

import 'CircleProgress.dart';
import 'languages/englishpage.dart';
...
class _DashboardState extends State<Dashboard>
  ...
  void initState() {
    ...
    databaseReference
      ...
      isLoading = true;
      _DashboardInit(x, humidity,moist);
    });
  }

  _DashboardInit(double temp, int humid,int moist) {
