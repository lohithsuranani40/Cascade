...
import 'package:projectapp1/languages/punjabipage.dart';
import 'package:rflutter_alert/rflutter_alert.dart';

import 'CircleProgress.dart';
import 'languages/punjabipage.dart';
import 'dart:async';
...
class _Dashboard2State extends State<Dashboard2>
  ...
  void initState() {
    ...
    databaseReference
      ...
      isLoading = true;
      _Dashboard2Init(x, humidity,moist);
    });
  }

  _Dashboard2Init(double temp, int humid,int moist) {
  ...
  Future<Null> handleSignOut() async {
    ...
    Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (context) => punjabipage()),
